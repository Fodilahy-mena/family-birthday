...
},{}],"data/family.json":[function(require,module,exports) {
module.exports = [{
...
var _family = _interopRequireDefault(require("./data/family.json"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log('Happy birthday...');
var families = []; // families = familyData;

console.log(families);
var tbody = document.querySelector('tbody');
var searchNameFilter = document.querySelector('.search');
var filterMonth = document.querySelector('.select');
console.log(searchNameFilter, filterMonth); // const resetFilter = document.querySelector('.reset-filters');
// console.log(resetFilter);

searchNameFilter.addEventListener('input', function () {
  return showFamilies(families);
});
...
function getNextBirthday(birthday) {
  ...
  var today = new Date(); // we check when is their next birthday. we check the date with the same month and day as their birthday, and add this year.

  var nextBirthDay = (0, _dateFns.setYear)(birthdayDate, today.getFullYear()); // if it's today, we return the value
...
function showFamilies(familiesList) {
  var familiesFilteredAndSorted = familiesList;

  if (searchNameFilter.value !== '') {
    familiesFilteredAndSorted = familiesFilteredAndSorted.filter(function (family) {
      var fullNameLowerCase = family.firstName.toLowerCase() + ' ' + family.lastName.toLowerCase();
  ...
  if (filterMonth.value !== '') {
    familiesFilteredAndSorted = familiesFilteredAndSorted.filter(function (family) {
      var birthday = new Date(family.birthday);
      return birthday.getMonth() === Number(filterMonth.value);
    });
  } // we sort from the soonest birthday to the last.


  familiesFilteredAndSorted.sort(function (a, b) {
    var dayBirthdayA = (0, _dateFns.differenceInCalendarDays)(getNextBirthday(a.birthday), new Date());
    var dayBirthdayB = (0, _dateFns.differenceInCalendarDays)(getNextBirthday(b.birthday), new Date());
    return (0, _dateFns.compareAsc)(dayBirthdayA, dayBirthdayB);
  });
  var html = familiesFilteredAndSorted.map(function (family) {
    var birthdayDate = new Date(family.birthday);
    console.log('birthday date', birthdayDate);
    var today = new Date();
    var nextBirthDay = getNextBirthday(birthdayDate); // we do the difference between this date and the next

    var daysBirthday = (0, _dateFns.differenceInCalendarDays)(nextBirthDay, today);
    return "\n        <tr data-id=\"".concat(family.id, "\" name=\"").concat(family.firstName, "\">\n        \n            <th scope=\"row\">\n                <img src=\"").concat(family.picture, "\" alt=\"").concat(family.firstName + ' ' + family.lastName, "\"/>\n            </th>\n            <td>\n                <span>").concat(family.firstName, " ").concat(family.lastName, "</span><br>\n            </td>\n            <td>\n                <strong>  ").concat(daysBirthday === 0 ? "He/She is ".concat((0, _dateFns.differenceInCalendarYears)(new Date(), birthdayDate) + 1, "</b> today") : "Turns <b>".concat((0, _dateFns.differenceInCalendarYears)(new Date(), birthdayDate) + 1, "</b> on the ").concat((0, _dateFns.lightFormat)(nextBirthDay, 'dd/MM')), "</sup></strong>\n            </td>\n            <td>").concat(daysBirthday === 0 ? "\uD83C\uDF82\uD83C\uDF82\uD83C\uDF82" : "\uD83C\uDF82  ".concat(daysBirthday, " days"), " left until ").concat(family.firstName, " ").concat(family.lastName, "'s birthday</td>\n            <td>\n                <button class=\"edit\">\n                    <img src=\"./edit.svg\" width=\"35\"/>\n                </button>\n            </td>\n            <td>\n                <button class=\"delete\">\n                    <img src=\"./del.svg\" width=\"35\"/>\n                </button>\n            </td>\n\t\t</tr>\n        ");
  }).join('');
...
var initLocalStorage = function initLocalStorage() {
  var stringFromLS = localStorage.getItem('families');
...
initLocalStorage();
},{"date-fns":"node_modules/date-fns/esm/index.js","waait":"node_modules/waait/index.js","./data/family.json":"data/family.json"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
